// Официальный многоцветный логотип Google ("G") — точные path из брендбука
// Google для кнопок "Sign in with Google". Не эмодзи и не самодельная
// иконка — оригинальная форма и цвета.
